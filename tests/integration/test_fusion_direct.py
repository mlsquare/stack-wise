#!/usr/bin/env python3
"""
Direct test script for FusionTrainer functionality.

This script directly imports the FusionTrainer file without going through package imports.
"""
...
def test_fusion_trainer_initialization():
    ...
    try:
        ...
        # Import FusionTrainer directly from file
...
def main():
    """Run all tests."""
    logger.info("Starting direct FusionTrainer tests...")
